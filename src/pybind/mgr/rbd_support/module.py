...
class Module(MgrModule):
        ...
        try:
            ...
            while True:
                with self.lock:
                    ...
                    stats_period = int(self.get_option("mgr_stats_period"))
    ...
    def get_perf_data(self, report, pool_spec, sort_by, extract_data):
        ...
        # pool_descriptors = {1: 'tem'} 
        # counters = [{'1/mmm': [813.6, 0.0, 3332505.6, 0.0, 4574120.156833626, 0.0]}]
