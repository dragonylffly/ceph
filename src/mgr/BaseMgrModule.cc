...
ceph_add_osd_perf_query(BaseMgrModule *self, PyObject *args)
{
  ...
  static const std::map<std::string, OSDPerfMetricSubKeyType> sub_key_types = {
    {"client_id", OSDPerfMetric::CLIENT_ID},
    {"client_address", OSDPerfMetric::CLIENT_ADDRESS},
    {"pool_id", OSDPerfMetric::POOL_ID},
    {"namespace", OSDPerfMetric::NAMESPACE},
    {"osd_id", OSDPerfMetric::OSD_ID},
    {"pg_id", OSDPerfMetric::PG_ID},
    {"object_name", OSDPerfMetric::OBJECT_NAME},
    {"snap_id", OSDPerfMetric::SNAP_ID},
  };
  static const std::map<std::string, PerformanceCounterType> counter_types = {
    {"ops", OSDPerfMetric::OPS},
    {"write_ops", OSDPerfMetric::WRITE_OPS},
    {"read_ops", OSDPerfMetric::READ_OPS},
    {"bytes", OSDPerfMetric::BYTES},
    {"write_bytes", OSDPerfMetric::WRITE_BYTES},
    {"read_bytes", OSDPerfMetric::READ_BYTES},
    {"latency", OSDPerfMetric::LATENCY},
    {"write_latency", OSDPerfMetric::WRITE_LATENCY},
    {"read_latency", OSDPerfMetric::READ_LATENCY},
  };
  ...
  boost::optional<OSDPerfMetricLimit> limit;
